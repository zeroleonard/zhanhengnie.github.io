...
export const awards: Award[] = [
  ...
  { title: { en: 'National Encouragement Scholarship (Top 10%)', zh: '国家励志奖学金（前 10%）' }, year: '2022-2024' },
  { title: { en: 'Outstanding Graduate, Beihang University', zh: '北航优秀毕业生' }, year: '2024' },
  { title: { en: 'First Prize, National Mathematical Modeling Contest (Beijing)', zh: '全国大学生数学建模竞赛北京赛区一等奖' }, year: '2022' },
